...
export default async function SubcategoryPage({
  ...
  const categoryKey = Array.isArray(categoryKeyArray) && categoryKeyArray.length > 0 ? categoryKeyArray[0] : "";
            ...
            {subcategories.map((sub) => (
              <li key={sub.subCategoryKey}>
                <a
                  ...
                  className={`block text-gray-700 hover:text-blue-600 transition font-medium ${sub.subCategoryKey === subCategoryKey ? "text-blue-600 font-bold" : ""
                    }`}
                >
                  {sub.subCategoryName}
                </a>
